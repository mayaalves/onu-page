...
Andando pelo Parque não se vê qualquer vestígio do poder público, até as lixeiras são improvisadas.
</S.P>
      </S.BoxP>
  ...
  return (
    <S.Container>
      ...
      <S.Paragrafos>
        ...
        ecológico da Vila do Pinheiro(Mata dos macacos), além de seus outros instrumentos como o anfiteatro e o campo de futebol.
      </S.Paragrafos>
      <S.Paragrafos>1.2- Mapeamento de áreas para plantio de arvorés, além de ampliação e criação de parques e praças públicas, onde haveriam areas de horta e estufas administradas pelos moradores </S.Paragrafos>
      <S.Paragrafos>1.3- Re-urbanização das areas amplas e ruas largas, aumentando as calçadas e fazendo o plantio de arvores já desenvolvidas, dimunuindo assim o trabalho e o cuidado da população e do poder público.</S.Paragrafos>
      <S.Paragrafos>1.4- Criação com financiamento público ou privado de hortas construídas nas lajes das casas, administradas pelos próprios donos dos imóveis, pra venda dos insumos produzidos através de coletivos.</S.Paragrafos>
    </S.Container>
  );
}